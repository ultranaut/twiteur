...
(function ($, window, document, undefined) {
    ...
    $.fn.extend({
      ...
      linkUser: replacer(regex.user, "@<a href=\"http://"+s.twitter_url+"/$1\">$1</a>"),
      linkHash: replacer(regex.hashtag, ' <a href="'+search_url+'/search?tag=$1&lang=all">#$1</a>')
    });
